...
def save_station1_form(request):
    ...
    try:
        ...
        try:
            print("printing")
            TestleadSmartsyncx.write_register(HmiAddress.S1_SET_OPEN_TORQUE, open_degree_s1)
            TestleadSmartsyncx.write_register(HmiAddress.S1_SET_CLOSE_TORQUE, close_degree_s1)
...
def save_station2_form(request):
    ...
    try:
        ...
        # Write to Modbus registers
        try:
            TestleadSmartsyncx.write_register(HmiAddress.S2_SET_OPEN_TORQUE, open_degree_s2)
            TestleadSmartsyncx.write_register(HmiAddress.S2_SET_CLOSE_TORQUE, close_degree_s2)
        except Exception as e:
            print(f"Error writing to Modbus: {e}")
